...
date: 2024-01-25T18:10:52.722Z
description: >-
  我們將重點放在如何使用 Streamlit 來建立一個視覺化的操作介面，以便 Demo 整個RAG（Retrieval-Augmented
  Generation）的工作流程。
category: 技術
tags:
  - llm
  ...
  - Tutorial
source: medium
hero: /assets/c7d1dac2494e/1*uxugOdrNhxIealY_oZo4sg.png
---
...
如果你對這個專案感興趣，並想親自嘗試建造和運行，我將 code 放在 [github](https://github.com/wsxqaza12/RAG_LangChain_streamlit) ，你可以藉由以下步驟快速架設你自己的 streamlit Demo：
### 步驟1\. Clone 專案
```bash
...
_[Post](https://medium.com/@cch.chichieh/rag%E5%AF%A6%E4%BD%9C%E6%95%99%E5%AD%B8-streamlit-langchain-llama2-c7d1dac2494e) converted from Medium by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
