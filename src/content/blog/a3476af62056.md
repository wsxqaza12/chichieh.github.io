---
title: >-
  OpenManus Tutorial: How to Build Your Custom AI Agent in 2025 (Beginner’s
  Guide)
date: 2025-03-17T20:49:54.142Z
description: "Build custom AI agents with OpenManus, the accessible open-source alternative to Manus. Step-by-step guide for both terminal and web\_…"
category: 技術
tags:
  ...
  - step-by-step-guide
source: medium
hero: /assets/a3476af62056/1*v-YNOl49XEArHOt64Z3BWw.png
---
...
[OpenManus](https://github.com/mannaandpoem/OpenManus) is an open\-source project available on Github\. While it has been packaged for easy use, it primarily runs through the command line\. If you prefer a web\-based interface, refer to the OpenManusWeb tutorial below\. This guide assumes a Linux environment\.
...
To get started, clone the [OpenManus](https://github.com/mannaandpoem/OpenManus) repository to your local machine:
```bash
...
_[Post](https://medium.com/@cch.chichieh/openmanus-tutorial-how-to-build-your-custom-ai-agent-in-2025-beginners-guide-a3476af62056) converted from Medium by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
