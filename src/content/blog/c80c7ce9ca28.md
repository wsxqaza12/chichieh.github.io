...
tags:
  ...
  - 性能與加速
source: medium
hero: /assets/c80c7ce9ca28/1*Wn0whF_md63917s6RuAs8A.png
---
![](/assets/c80c7ce9ca28/1*Wn0whF_md63917s6RuAs8A.png)

### Polars 簡介

Polars 是一個用 Rust 語言編寫的快速數據處理庫，這是一種低階運作的語言，沒有外部依賴。Rust 記憶體效率高，效能與 [C](https://realpython.com/c-for-python-programmers/) 或 [C\+ \+](https://realpython.com/python-vs-cpp/) 相當，因此很適合來設計來優化大型數據集的處理速度。它的核心優勢在於其高效的記憶體管理和多核心處理能力，這使得在大規模數據集上的操作比使用 Pandas 快得多。
### 為什麼選擇 Polars？
- 性能優化：Polars 運用了多線程和有效的記憶體使用策略，對大數據集進行高效處理，Polars 的查詢引擎利用 [Apache Arrow](https://arrow.apache.org/) 來執行 [向量化](https://www.sciencedirect.com/topics/computer-science/vectorization) 查詢。
...
_[Post](https://medium.com/@cch.chichieh/pandas-%E5%8A%A0%E9%80%9F-polars-%E5%AE%89%E8%A3%9D%E8%88%87%E6%95%99%E5%AD%B8-c80c7ce9ca28) converted from Medium by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
