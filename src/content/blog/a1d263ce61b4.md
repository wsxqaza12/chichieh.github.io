...
date: 2025-06-06T16:05:34.844Z
description: >-
  Ditch v0 fees — export code & spin up Next.js 15 locally with Cursor/Windsurf,
  Bun & Node 22. Cut costs, gain speed, full control.
category: 技術
tags:
  - vibe-coding
  - cursor
  ...
  - ai
source: medium
hero: /assets/a1d263ce61b4/1*yOYamOQHDSfrcNGEliIP1w.png
---
...
1. `cookies` : Refer to [Github Issues](https://github.com/supabase/supabase/issues/30021)
2. `params` : Refer to [Stackoverflow](https://stackoverflow.com/questions/79465960/react-a-param-property-was-accessed-directly-with-params)
