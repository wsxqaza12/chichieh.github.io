...
tags:
  ...
  - 性能與加速
source: medium
hero: /assets/1c7b2f538c8f/1*q7FnsGmGbiUfrpWk6GXhTw.png
---
...
2. 到 [Anaconda repo](https://repo.anaconda.com/archive/) 找到適合你的 releases
...
之後重新整理後就可以在 zsh 使用 `conda` ，但 `create` 等功能還不能使用，所以我們接下來用 `conda init zsh` 設定，可以參考 [stackoverflow](https://stackoverflow.com/questions/53995171/anaconda-conda-error-argument-command-invalid-choice-when-trying-to-update-pa) 。如此便能成功在 zsh 中使用 conda 了。
```bash
source ~/.zshrc
conda init zsh 
```
...
_[Post](https://medium.com/@cch.chichieh/wsl2-%E5%AE%89%E8%A3%9D-conda-1c7b2f538c8f) converted from Medium by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
