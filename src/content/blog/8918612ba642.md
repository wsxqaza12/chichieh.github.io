...
date: 2025-03-15T09:21:50.470Z
description: >-
  中國初創公司 Monica 發布的 Manus，被譽為「全球第一個通用型 AI。因此本篇將介紹如何使用
  OpenManus，而對於不熟悉終端機的使用者，我也會介紹結合網頁介面的 OpenManusWeb，希望大家都能試試 AI agent 的魅力。
category: 技術
tags:
  - manus
  - ai-agent
  ...
  - 中文
source: medium
hero: /assets/8918612ba642/1*v-YNOl49XEArHOt64Z3BWw.png
---
...
[OpenManus 開源於 Github](https://github.com/mannaandpoem/OpenManus) 中，作者們將其包裝得非常易用，不過整體的操作還是介面還是在終端機上，對於習慣網頁介面的使用者可以參考下面的 OpenManusWeb 教學，我使用的環境都會以 Linux 為主。
#### 步驟 1：準備環境
...
把 [OpenManus](https://github.com/mannaandpoem/OpenManus) 的 repo clone 下來。
```bash
...
OpenManusWeb 是建立於 OpenManus 基礎上的專案，由 YunQiAI 開發，旨在提供更直觀、易用的網頁介面。該專案一樣開源於 [Github](https://github.com/YunQiAI/OpenManusWeb) ，相似的專案我還有測試過 [OpenManus\-WebUI](https://github.com/Shybert-AI/OpenManus-WebUI) ，但安裝較為複雜，可以再觀望。
...
把 [OpenManusWeb](https://github.com/YunQiAI/OpenManusWeb) 的 repo clone 下來。
```bash
...
_[Post](https://medium.com/@cch.chichieh/openmanus-tutorial-8918612ba642) converted from Medium by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
