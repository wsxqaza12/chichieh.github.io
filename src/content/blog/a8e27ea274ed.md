...
date: 2025-02-03T09:37:52.685Z
description: >-
  虛擬人偶（Avatar）早已是我們數位生活中的一部分，從遊戲角色到社交媒體的個性化形象，它們一直以多種形式出現在不同場合。然而，隨著 GenAI
  的強勢崛起，AI 驅動的 Avatar（AI…
category: 技術
tags:
  - avatar
  - ai
  ...
  - AI Avatar & 虛擬人偶
source: medium
hero: /assets/a8e27ea274ed/1*hqt1Bggq2TkgWtExiYr4XA.png
---
...
2. **添加骨骼與動態捕捉：** 設置骨架並權重綁定（Rigging），為角色賦予動作控制能力，利用 **Motion Capture** 技術捕捉真人動作，或使用 [**Mixamo**](https://www.mixamo.com/) 產生動作應用於角色。
...
[Wav2Lip 開源在 Github](https://github.com/Rudrabha/Wav2Lip?tab=readme-ov-file) ，並有提供 [Colab Notebook](https://colab.research.google.com/drive/1tZpDWXz49W6wDcTprANRGLo2D_EbD5J8?usp=sharing) 給大家直接實作，有興趣可以試試。
...
此類技術不僅能同步嘴唇，還能生成頭部運動與部分表情變化，使 Avatar 的動作更具真實感。代表技術包括 [**SadTalker**](https://github.com/OpenTalker/SadTalker) 和 [**Thin\-Plate Spline Motion Model \(TPSMM\)**](https://github.com/yoyo-nb/Thin-Plate-Spline-Motion-Model) ，兩者皆開源在 Github **，** 這些技術能夠讓靜態圖片轉變為具有語音同步與頭部運動的影片。
...
這類技術透過關鍵點驅動影像中的臉部動作，讓 AI 模型能夠模仿真人的完整表情與頭部運動。常用技術包括 [**First\-Order\-Motion Model \(FOMM\)**](https://github.com/AliaksandrSiarohin/first-order-model) **，** 也可以使用整合 **FOMM** 的 [**LivePortrait**](https://github.com/KwaiVGI/LivePortrait) 。
...
這類技術透過深度學習進行換臉，生成效果細膩但需要訓練時間。代表技術包括 [**DeepFaceLab**](https://github.com/iperov/DeepFaceLab) 和 [**FaceFusion**](https://github.com/facefusion/facefusion) ，其中 FaceFusion 是一款簡化版的 DeepFaceLab，很適合一般用戶使用。
...
即時換臉技術能讓使用者在直播或影片通話中即時替換臉部，應用於 VTuber 直播、AI 角色互動等場景。代表技術包括 [**SimSwap**](https://github.com/neuralchen/SimSwap) 、 [**Deep\-Live\-Cam**](https://github.com/hacksider/Deep-Live-Cam) 和 [**Roop**](https://github.com/s0md3v/roop) ，這些技術透過 AI 演算法讓一個人的臉即時變成另一個人的臉，並保持原始影片的流暢度，大家應該常在短影音平台看到許多人在做類似的影片。
...
_[Post](https://medium.com/@cch.chichieh/ai-avatar-%E8%99%9B%E6%93%AC%E4%BA%BA%E5%81%B6%E7%9A%84%E8%A3%BD%E4%BD%9C%E8%88%87%E7%A8%AE%E9%A1%9E-a8e27ea274ed) converted from Medium by [ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)._
